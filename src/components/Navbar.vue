  ...
  <header class="navbar dark:bg-backgroundDark dark:border-b dark:border-primary/10 sticky top-0 z-10 shadow-sm">
    ...
    <section class="flex-1">
      <div class="form-control">
        <input type="text" placeholder="Search"
          class="input input-bordered w-48 m1-2 md:w-auto dark:bg-white/5 dark:backdrop-blur-md dark:[--webkit-backdrop-filter:blur(10px)] dark:border-white/10" />
      </div>
    </section>
    ...
    <section class="flex gap-6">
      ...
      <div class="dropdown dropdown-end">
        ...
        w-58 space-y-3 dark:bg-backgroundDark **:font-semobold **:text-base">
          <li><a>Profile</a></li>
          <li><a>Settings</a></li>
          <li><a>Log Out</a></li>
        </ul>
